...
You can download the latest sample app [here](https://github.com/rubengees/introduction/releases/download/1.3.6/sample-release.apk).
...
```groovy
dependencies {
    compile ('com.github.rubengees:introduction:1.3.6@aar'){
        transitive = true;
    }
}
```
...
Detailed Javadoc can be found [here](https://jitpack.io/com/github/rubengees/introduction/1.3.6/javadoc/).
...
<a href="http://www.methodscount.com/?lib=com.github.rubengees%3Aintroduction%3A1.3.6"><img src="https://img.shields.io/badge/Methods and size-core: 307 | deps: 16517 | 54 KB-e91e63.svg"/></a>  
